...
@section('isihalaman')
    <h3>
        <center>Data Pembelian Buku</center>
        <h3>
            <h3>
                <center>Perpustakaan Cortis</center>
            </h3>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                    data-target="#modalPembelianEdit{{ $p->id_pembelian }}">
                                    Edit
                                </button>

                                <!-- Awal Modal EDIT data Pembelian -->
                                <div class="modal fade" id="modalPembelianEdit{{ $p->id_pembelian }}" tabindex="-1"
                                    role="dialog" aria-labelledby="modalPembelianEditLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalPembelianEditLabel">Form Edit Data
                                                    Pembelian</h5>
                                            </div>
                                            <div class="modal-body">

                                                <form name="formpembelianedit" id="formpembelianedit"
                                                    action="/pembelian/edit/{{ $p->id_pembelian }} " method="post"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    {{ method_field('PUT') }}
                                                    <div class="form-group row">
                                                        <label for="id_pembelian" class="col-sm-4 col-form-label">ID
                                                            Pembelian</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="id_pembelian"
                                                                name="id_pembelian" value="{{ $p->id_pembelian }}" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="pembeliantambah"
                                ...
                                |
                                <a href="pembelian/hapus/{{ $p->id_pembelian }}"
            ...
            <div class="modal fade" id="modalPembelianTambah" tabindex="-1" role="dialog"
                aria-labelledby="modalPembelianTambahLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <form name="formpembeliantambah" id="formpembeliantambah" action="/pembelian/tambah "
